...
class TextEditorApp:
    ...
    def undo(self):
        # Deshacer (sin funcionalidad real)
        self.bind('<Control-z>', self.deshacer)
        messagebox.showinfo("Deshacer", "Funcionalidad no implementada.")

    def redo(self):
        # Rehacer (sin funcionalidad real)
        messagebox.showinfo("Rehacer", "Funcionalidad no implementada.")

    def show_info(self):
        messagebox.showinfo("Información", "Editor de Texto v1.0\nLicencia MIT\nDesarrollado por Grupo 3.")
