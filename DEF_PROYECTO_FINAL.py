...
class EditorDeTexto:
    def __init__(self, root):
        ...
        self.menu.add_cascade(label="Archivo", menu=self.file_menu)  # Muestra el menú Archivo en cascada
        ...
        self.menu.add_cascade(label="Editar", menu=self.edit_menu)  # Muesta el menú Editar en cascada
        ...
        self.menu.add_cascade(label="Ayuda", menu=self.help_menu)  # Muestra el menú ayuda  en cascada 
    ...
    def open_manual(self):
        ...
        os.startfile("C:/Users/Mgiro/OneDrive - Universidad Mariano Gálvez/Segundo Semestre/algoritmos/proyecto final/Manual de usuario.pdf")  # Abre el manual de usuario ubicado en esa ruta
